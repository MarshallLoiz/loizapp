...
exports.mustBeLoggedIn = function(req, res, next) {
    if (req.session.user) {
        ...
        req.flash("errors", "You must be logged in to perfrom that action.")
...
exports.register = function(req, res) {
   ...
   user.register().then(() => {
    sendgrid.send({
        to: req.body.email,
        from: 'loizapp@mail.com',
        subject: "Welcome to LApp!",
        text: 'Welcome to loizapp have a great day!',
        html: 'Welcome to <strong>loizapp</strong> have a great day!'
    })
...
exports.profileFollowingScreen = async function(req, res) {
    try {
      ...
      res.render('profile-following', {
           title: `${req.profileUser.username} Following`,
...
exports.profileFollowersScreen = async function(req, res) {
  try {
    ...
    res.render('profile-followers', {
        title: `${req.profileUser.username} Followers`,
